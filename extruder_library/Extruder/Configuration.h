...
#define MELTING_TEMPERATURE 150 		//If the melting heaters are below this temperature, the motor can't be turned on (0 to deactivate feature)

//Heater PWM limit (used to limit the power of the heaters)
#define HEATER_MAX_PWM 0.8 //value from 0 to 1
...
#define HEATER_1_SETPOINT 60
#define HEATER_2_SETPOINT 60
#define HEATER_3_SETPOINT 60
